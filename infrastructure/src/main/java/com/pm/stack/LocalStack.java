...
public class LocalStack extends Stack {
   ...
   private final Cluster ecsCluster;
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        super(scope, id, props);
         ...
         FargateService authService = createFargateService(
                 ...
                 List.of(4005),
                 authServiceDb,
                 Map.of("JWT_SECRET", "JfhBErxN1AloxeKrUShAt2j0G9vpE8t0lJIIbPL4qxI"));
    ...
    private Vpc createVpc() {
        return Vpc.Builder
                .create(this, "PatientManagmentVPC")
        ...
        return DatabaseInstance.Builder
                ...
                .engine(DatabaseInstanceEngine.postgres(
                        PostgresInstanceEngineProps.builder()
                                .version(PostgresEngineVersion.of("18.4", "18"))
                                .build()
                ))
                .vpc(vpc)
    ...
    private Cluster createEcsCluster() {
        return Cluster.Builder.create(this, "PatientManagmentCluster")
                .vpc(vpc)
    ...
    private FargateService createFargateService( String id,
        ...
        if(db != null) {
            ...
            envVars.put("SPRING_DATASOURCE_HIKARI_INITIALIZAION_FAIL_TIMEOUT", "60000");
        }
    ...
    private void createApiGatewayService() {
        ...
        ContainerDefinitionOptions containerOption = ContainerDefinitionOptions.builder()
        ...
        taskDefinition.addContainer("APIGatewayContainer", containerOption);
